...
const translations: Record<Locale, Dict> = {
  en: {
    ...
    "subscriptions.headers.lastReset": "last_reset",
    ...
    "adminPlans.hidden": "Hidden",
    "adminPlans.create": "Create",
    "adminPlans.created": "Created {{planId}}",
    "adminPlans.updated": "Updated {{planId}}",
    ...
    "adminPlans.headers.hidden": "hidden",
  ...
  zh: {
    ...
    "subscriptions.headers.lastReset": "上次重置",
    ...
    "adminPlans.hidden": "前端隐藏",
    "adminPlans.create": "创建",
    "adminPlans.created": "已创建 {{planId}}",
    "adminPlans.updated": "已更新 {{planId}}",
    "adminPlans.save": "保存",
